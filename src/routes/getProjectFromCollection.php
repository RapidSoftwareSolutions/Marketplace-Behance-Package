...
$app->post('/api/Behance/getProjectFromCollection', function ($request, $response) {
    ...
    $url = $url.$queryParam['collectionId'].'/projects';
    unset($queryParam['collectionId']);
