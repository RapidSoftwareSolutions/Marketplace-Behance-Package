...
$app->post('/api/Behance/getProjectComments', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['clientId','projectId']);
    ...
    //compose full url
    $url = $url.$queryParam['projectId'].'/comments';
